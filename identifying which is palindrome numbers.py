...
if define_integers == check_num:
    print('\nYES. The given reversed numerical is', check_num, 'and it is defines as palindrome number\n')

#function to define if the given is not a palindrome number 
else :
    print('\nNO. The given reversed numerical is', check_num, 'and it is defines as not palindrome number.\n')